...
const analyzeResume = async () => {
    try {
      ...
      console.log("Calling student profile API...");
      ...
      console.log("Profile API response:", profile.data);
  
      const studentId = profile.data.student?._id;
      ...
      console.log("Calling Resume AI API...");
  
      const response = await api.post("/resume-ai/analyze", {
        studentId: studentId,
      });
  
      console.log("Resume AI response:", response.data);
